...
def translate(context, text, comment=None, qt_translate=QtCore.QCoreApplication.translate):
    ...
    that we can change it if at a later date if necessary, without having to redo the whole of Paper.
...
from .papermixin import PaperMixin
