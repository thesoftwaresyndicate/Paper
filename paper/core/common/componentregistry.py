...
###############################################################################
"""
Provide Component Registry Services
"""
import logging
import sys
...
class ComponentRegistry(object):
    ...
    def get(self, key):
        ...
        :param key: The component to be retrieved.
        """
        if key in self.component_list:
            return self.component_list[key]
        else:
    ...
    def register(self, key, reference):
        ...
        :param key: The component to be created this is usually a major class like "renderer" or "main_window" .
        :param reference: The component address to be saved.
        """
        if key in self.component_list:
            trace_error_handler(log)
            log.error('Duplicate component exception %s' % key)
            raise KeyError('Duplicate component exception %s' % key)
        else:
            self.component_list[key] = reference
    ...
    def remove(self, key):
        ...
        :param key: The component to be deleted.
        """
        if key in self.component_list:
            del self.component_list[key]
